...
export const BugReportsIcon = ({ size = 20, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const UsersIcon = ({ size = 22, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SortIcon = ({ size = 16, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const AppLogo = ({ size = 42, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 100 100"
  ...
  >
    ...
    {/* Clean stylized ribbon 'A' logo from Page 1 */}
    <path 
      d="M50 15 L22 80 L38 80 L50 52 L62 80 L78 80 Z" 
      fill="url(#logoGrad)" 
      filter="url(#shadow)"
    />
    <path 
      d="M50 52 L38 80 L62 80 Z" 
      fill="#030712" 
      opacity="0.15"
    />
    <circle cx="50" cy="58" r="7" fill="#ffffff" />
    <circle cx="48" cy="59" r="3.5" fill="url(#logoGrad)" />
  </svg>
);

export const CoursesIcon = ({ size = 20, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
